...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.compileClosure = function(o) {
      ...
      if (func.isAsync || ((ref3 = func.base) != null ? ref3.isAsync : void 0)) {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    function Code(params, body, tag) {
      ...
      this.isAsync = !!this.body.contains(function(node) {
        return (node instanceof Op && node.isAwait()) || node instanceof AwaitReturn;
      });
      this.isGenerator = !!this.body.contains(function(node) {
        return (node instanceof Op && node.isYield()) || node instanceof YieldReturn;
      });
      if (this.isAsync && this.isGenerator) {
        this.error("function may not contain both `yield` and `await` expressions. Async Generators are not currently supported.");
      }
    }
  ...
  exports.Op = Op = (function(superClass1) {
    ...
    Op.prototype.isAwait = function() {
      var ref3;
      return (ref3 = this.operator) === 'await';
    };
    ...
    Op.prototype.compileAwait = function(o) {
      var op, parts, ref3;
      parts = [];
      op = this.operator;
      if (o.scope.parent == null) {
